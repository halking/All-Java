...
@EffectCode(value = Effect.SEND_TEXT)
@Service
public class SendTextEffect implements IEffect {

	private static Logger log = LoggerFactory.getLogger(SendTextEffect.class);
	...
	public void handle(Map<String, Object> map) {
		...
		if(value!=null&&value.size()>0){
			...
			String content = effectJson.getString("content");
			conversationModel = new ConversationModel();

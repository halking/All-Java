...
import com.d1m.wechat.wxsdk.core.req.model.message.IndustryTemplateAdd;
import com.d1m.wechat.wxsdk.core.req.model.message.IndustryTemplateMessageSend;
import com.d1m.wechat.wxsdk.core.req.model.message.IndustryTemplateSet;
...
public class JwTemplateMessageAPI {
	 ...
	 */
	public static String setIndustry(String accessToken, String industry_id1,
			String industry_id2) throws WechatException {
	 ...
	 * @throws WechatException
	 */
	public static String addTemplate(String accessToken,
			String template_id_short) throws WechatException {
	 ...
	 * @throws WechatException
	 */
	public static String sendTemplateMsg(
			IndustryTemplateMessageSend industryTemplateMessageSend)
			throws WechatException {
		JSONObject result = sendTemplateMsg0(industryTemplateMessageSend);
		String msg = result.getString(WeiXinConstant.RETURN_ERROR_INFO_MSG);
		return msg;
	}

	public static JSONObject sendTemplateMsg0(
			IndustryTemplateMessageSend industryTemplateMessageSend)
			throws WechatException {
		return WeiXinReqService.getInstance().doWeinxinReqJson(
	...
	//		industryTemplateMessageSend
	//				.setTemplate_id("4m3vrpiSA-CPyL9YqHw2jKDlZSX6Sz65SoMKvA9BV1s");
	//		industryTemplateMessageSend
	//				.setTouser("oR0jFtxn8q_UsSXsKT395GVaG8q0");
    ...
    //
	//		s = JwTemplateMessageAPI
	//				.sendTemplateMsg(industryTemplateMessageSend);
    //
	//		System.out.println(s);

...
import com.d1m.wechat.wxsdk.core.req.model.kfaccount.KfOnlineAccountList;
import com.d1m.wechat.wxsdk.core.req.model.kfaccount.KfaccountAdd;
import com.d1m.wechat.wxsdk.core.req.model.kfaccount.KfaccountDel;
import com.d1m.wechat.wxsdk.core.req.model.kfaccount.KfaccountList;
import com.d1m.wechat.wxsdk.core.req.model.kfaccount.KfaccountUpdate;
...
import com.d1m.wechat.wxsdk.core.sendmsg.model.WxKfaccount;
...
public class JwKfaccountAPI {
	 ...
	 * nickname 是 客服昵称，最长6个汉字或12个英文字符 password 是 客服账号登录密码，格式为密码明文的32位加密MD5值
	 * 
	 * @param accessToken
	 * @param kf_account
	 * @param nickname
	...
	public static String addKfacount(String accessToken, String kf_account,
			String nickname, String password) throws WechatException {
	 ...
	 * @throws WechatException
	 */
	public static String uploadKfaccountHeadimg(String accessToken,
			String kf_account, String filePathName) throws WechatException {
	 ...
	 * @throws WechatException
	 */
	public static List<WxKfaccount> getAllKfaccount(String accessToken)
			throws WechatException {
	...
	/**
	 * 
	 * 发送客服信息 access_token 是 调用接口凭证 touser 是 普通用户openid msgtype 是
	 * 消息类型，文本为text，图片为image，语音为voice，视频消息为video，音乐消息为music，图文消息为news content 是
	 * 文本消息内容 media_id 是 发送的图片/语音/视频的媒体ID thumb_media_id 是 缩略图的媒体ID title 否
	 * 图文消息/视频消息/音乐消息的标题 description 否 图文消息/视频消息/音乐消息的描述 musicurl 是 音乐链接
	 * hqmusicurl 是 高品质音乐链接，wifi环境优先使用该链接播放音乐 url 否 图文消息被点击后跳转的链接 picurl 否
	 * 图文消息的图片链接，支持JPG、PNG格式，较好的效果为大图640*320，小图80*80
	 * 
	 * @throws WechatException
	 */
	public static String sendKfMessage(KfcustomSend kfcustomSend)
			throws WechatException {
		JSONObject result = WeiXinReqService.getInstance().doWeinxinReqJson(
				kfcustomSend);
	...
	/**
	 * 获取在线客服信息 kf_account 完整客服账号，格式为：账号前缀@公众号微信号 status 客服在线状态
	 * 1：pc在线，2：手机在线。若pc和手机同时在线则为 1+2=3 kf_id 客服工号 auto_accept 客服设置的最大自动接入数
	 ...
	 * @throws WechatException
	 */
	public static List<WxKfaccount> getAllOnlineKfaccount(String accessToken)
			throws WechatException {
	...
	public static void main(String[] args) {
		try {
			...
			for (WxKfaccount a : ls) {
				System.out.println(a.getKf_account() + "---" + a.getKf_id()
						+ a.getKf_nick());
